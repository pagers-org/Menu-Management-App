# 😊문벅스 카페 메뉴 앱 드릴😊
> 기초까지 뚫어보고 천장까지 쌓아보자✍️

<br>

## 💻 사용법
> **lerna**와 **yarn**이 설치되어 있어야 합니다!
...
yarn @id:start
```
- 예시 : 프로젝트명은 자동으로 소문자 치환됩니다. 따라서 대문자를 반드시 소문자로 바꾸고 진행해주세요.
  ```sh
...
## ✔ 개요
> **프론트엔드 드릴 다운(Front-end Drill Down)**

기본기에 충실해지기 위해 동일한 환경에서 다른 방법으로 앱을 구현하는 저장소입니다.

- 언어 : JavaScript / Typescript
- 테스트 : Jest / Cypress
- 빌더 : Webpack / Vite
- 스타일 : CSS / Sass / CSS in JS
